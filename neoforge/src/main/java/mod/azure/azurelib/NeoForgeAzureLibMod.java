...
public final class NeoForgeAzureLibMod {
    ...
    public class AzureBlocks {
        ...
        public static final RegistryObject<Block> TICKING_LIGHT_BLOCK = BLOCKS.register("lightblock", TickingLightBlock::new);
    ...
    public class AzureEntities {
        ...
        public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, AzureLib.MOD_ID);
        ...
        public static final RegistryObject<BlockEntityType<StargateBlockEntity>> STARGATE_BLOCK_ENTITY = TILE_TYPES.register("stargate", () -> BlockEntityType.Builder.of(StargateBlockEntity::new, AzureBlocks.STARGATE_BLOCK.get()).build(null));
        public static final RegistryObject<EntityType<MarauderEntity>> MARAUDER = ENTITY_TYPES.register("maruader", () -> EntityType.Builder.of(MarauderEntity::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8).build(AzureLib.MOD_ID + ":marauder"));
    }
    ...
    public class AzureItems {
        ...
        public static final RegistryObject<Item> DOOMICORN_HELMET = ITEMS.register("doomicorn_helmet", () -> new DoomicornArmor(
                ArmorItem.Type.HELMET));
        public static final RegistryObject<Item> DOOMICORN_CHESTPLATE = ITEMS.register("doomicorn_chestplate", () -> new DoomicornArmor(
                ArmorItem.Type.CHESTPLATE));
        public static final RegistryObject<Item> DOOMICORN_LEGGINGS = ITEMS.register("doomicorn_leggings", () -> new DoomicornArmor(
                ArmorItem.Type.LEGGINGS));
        public static final RegistryObject<Item> DOOMICORN_BOOTS = ITEMS.register("doomicorn_boots", () -> new DoomicornArmor(
