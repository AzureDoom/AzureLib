...
/**
 * The {@link mod.azure.azurelib.core.animatable.GeoAnimatable GeoAnimatable} interface specific to
 * {@link net.minecraft.world.item.Item Items}. This also applies to armor, as they are just items too.
 */
@Deprecated()
public interface GeoItem extends SingletonGeoAnimatable {
     ...
     * {@link net.minecraft.client.renderer.block.model.ItemTransforms.TransformType render perspective}
     */
