...
public class GeoItemRenderer<T extends Item & GeoAnimatable> extends BlockEntityWithoutLevelRenderer implements GeoRenderer<T> {
     ...
     * {@link net.minecraft.client.renderer.block.model.ItemTransforms.TransformType#GUI} normally).<br>
    ...
    protected void renderInGui(
        ...
        MultiBufferSource.BufferSource defaultBufferSource = bufferSource instanceof MultiBufferSource.BufferSource
    ...
    public void fireCompileRenderLayersEvent() {
        GeoRenderEvent.Item.CompileRenderLayers.EVENT.invoker()
            .handle(new GeoRenderEvent.Item.CompileRenderLayers(this));
    }
    ...
    public boolean firePreRenderEvent(
        ...
        return GeoRenderEvent.Item.Pre.EVENT.invoker()
            .handle(new GeoRenderEvent.Item.Pre(this, poseStack, model, bufferSource, partialTick, packedLight));
    }
    ...
    public void firePostRenderEvent(
        ...
        GeoRenderEvent.Item.Post.EVENT.invoker()
            .handle(new GeoRenderEvent.Item.Post(this, poseStack, model, bufferSource, partialTick, packedLight));
    }
}
