...
public final class AzureLibCache {
	private static final List<String> EXCLUDED_NAMESPACES = Arrays.asList("animatedmobsmod", "moreplayermodels", "customnpcs", "dungeons_mobs", "gunsrpg", "mimic", "celestisynth", "the_flesh_that_hates", "enemyexpansion", "mutationcraft");
