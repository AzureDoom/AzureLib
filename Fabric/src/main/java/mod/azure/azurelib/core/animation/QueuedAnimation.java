...
/**
 * {@link Animation} and {@link mod.azure.azurelib.core.animation.Animation.LoopType} override pair, used to define a
 * playable animation stage for a {@link GeoAnimatable}
 */
@Deprecated()
