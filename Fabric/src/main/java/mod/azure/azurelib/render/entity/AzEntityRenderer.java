...
public abstract class AzEntityRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    protected AzEntityRenderer(AzEntityRendererConfig<T> config, EntityRenderDispatcher context) {
        super(context);
        this.config = config;
    ...
    @Override
    public int getBlockLightLevel(@NotNull T entity, @NotNull float pos) {
