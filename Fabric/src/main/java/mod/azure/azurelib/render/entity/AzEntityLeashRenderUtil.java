...
public class AzEntityLeashRenderUtil {
    ...
    public static <T extends Entity, E extends Entity, M extends Mob> void renderLeash(
        ...
        Vec3 leashOffset = new Vec3(0.0D, mob.getEyeHeight(), (mob.getBbWidth() * 0.4F));
        ...
        Vec3 ropeGripPosition = leashHolder.getCommandSenderWorldPosition()
            .add(0.0D, leashHolder.getEyeHeight() * 0.7D, 0.0D);
        ...
        int entityBlockLight = azEntityRenderer.getBlockLightLevel((T) mob, entityEyePos.getY());
