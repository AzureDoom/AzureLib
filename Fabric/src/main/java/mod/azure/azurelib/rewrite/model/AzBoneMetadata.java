...
/**
 * AzBoneMetadata is a class representing metadata about a 3D model bone. This metadata provides information such
...
public class AzBoneMetadata {
    ...
    public AzBoneMetadata(@Nullable Boolean dontRender,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzBoneMetadata)) return false;

        AzBoneMetadata that = (AzBoneMetadata) o;

        if (dontRender != null ? !dontRender.equals(that.dontRender) : that.dontRender != null) return false;
        if (inflate != null ? !inflate.equals(that.inflate) : that.inflate != null) return false;
        if (!mirror.equals(that.mirror)) return false;
