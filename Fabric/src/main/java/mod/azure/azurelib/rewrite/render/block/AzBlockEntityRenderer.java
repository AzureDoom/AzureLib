 ...
 */
public abstract class AzBlockEntityRenderer<T extends BlockEntity> extends BlockEntityRenderer<T> {
    ...
    protected AzBlockEntityRenderer(AzBlockEntityRendererConfig<T> config, BlockEntityRenderDispatcher context) {
        super(context);
