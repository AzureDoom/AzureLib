...
public class OptifineWarningScreen extends WarningScreen {
    ...
    protected void initButtons(int yOffset) {
        addRenderableWidget(
            Button.builder(
                OPEN_MODS_FOLDER,
                buttonWidget -> Util.getPlatform().openFile(Services.PLATFORM.modsDir().toFile())
            )
    ...
    private static final MutableComponent HEADER = Component.translatable("header.azurelib.optifine")
    ...
    private static final Component OPTIFINE_ALTERNATIVES = Component.translatable(
        "label.azurelib.optifine_alternatives"
    );
