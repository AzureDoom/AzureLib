...
import static mod.azure.azurelib.common.config.client.screen.AbstractConfigScreen.FOOTER_HEIGHT;
import static mod.azure.azurelib.common.config.client.screen.AbstractConfigScreen.HEADER_HEIGHT;
