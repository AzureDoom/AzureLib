...
public class AzLayerRenderer<T> {
     ...
     */
    protected void preApplyRenderLayers(mod.azure.azurelib.render.AzRendererPipelineContext<T> context) {
     ...
     */
    public void applyRenderLayersForBone(mod.azure.azurelib.render.AzRendererPipelineContext<T> context, AzBone bone) {
        for (var renderLayer : renderLayerSupplier.get()) {
     ...
     */
    protected void applyRenderLayers(mod.azure.azurelib.render.AzRendererPipelineContext<T> context) {
        for (var renderLayer : renderLayerSupplier.get()) {
