...
public class BooleanWidget extends AbstractWidget {
    ...
    public static final Component TRUE = new TranslatableComponent("text.azurelib.value.true")
        .withStyle(ChatFormatting.GREEN);

    public static final Component FALSE = new TranslatableComponent("text.azurelib.value.false")
