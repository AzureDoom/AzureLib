...
/**
 * AzDynamicEntityModelRenderer is an abstract class designed for rendering dynamic entity models
 * with support for complex transformations, render layers, and texture overrides. It extends the
 * functionality provided by the base AzEntityModelRenderer to allow for advanced rendering features
 * such as bone hierarchy processing, vertex manipulation, and configurable rendering pipelines.
 *
