...
public class AzAnimationControllerContainer<T> {
    ...
    /**
     * Adds one or more {@link AzAnimationController} instances to the container. Each controller is stored
     * in the container using its unique name as the key.
     *
     * @param controller the primary {@link AzAnimationController} to be added to the container.
     * @param controllers additional {@link AzAnimationController} instances to be added to the container.
     *                    Multiple controllers can be specified in the varargs.
     */
    @SafeVarargs
     ...
     * @return the {@link AzAnimationController} instance associated with the given name, or null if no such controller exists
     */
    ...
    /**
     * Retrieves all animation controllers managed by this container as a collection. Each controller
     * corresponds to an entry stored within the container, which are indexed by their unique names.
     *
