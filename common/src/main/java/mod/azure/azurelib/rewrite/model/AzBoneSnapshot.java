...
public class AzBoneSnapshot {
    ...
    public static AzBoneSnapshot copy(AzBoneSnapshot snapshot) {
        ...
        newSnapshot.offsetPosition.set(
            snapshot.offsetPosition.x(),
            snapshot.offsetPosition.y(),
            snapshot.offsetPosition.z()
        );
        newSnapshot.rotation.set(snapshot.rotation.x(), snapshot.rotation.y(), snapshot.rotation.z());
        newSnapshot.scale.set(snapshot.scale.x(), snapshot.scale.y(), snapshot.scale.z());
