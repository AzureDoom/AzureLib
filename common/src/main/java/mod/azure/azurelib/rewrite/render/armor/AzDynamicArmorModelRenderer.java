...
/**
 * The AzDynamicArmorModelRenderer class represents an abstract implementation of a dynamic
 * armor model renderer. It is a specialized extension of the AzArmorModelRenderer class, providing
 * additional functionality for rendering armor models dynamically with bone tracking, pose transformations,
 * and texture override support.
 * <p>
 * This class handles complex animation and rendering tasks, including
 * - Recursive rendering of bones with their transformations and hierarchies.
 * - Support for texture and render type overrides for specific bones.
 * - Vertex creation for quad meshes, including texture coordinate transformations.
 */
