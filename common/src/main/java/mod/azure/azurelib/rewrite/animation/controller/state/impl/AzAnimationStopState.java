...
public final class AzAnimationStopState<T> extends AzAnimationState<T> {
    ...
    /**
     * Updates the "stop" state within the animation state machine. In this state, no actions are performed,
     * as the stop state is meant to represent an idle or inactive behavior where no animations are running.
     * This method is a no-op, providing a placeholder for any update-related logic, should it be introduced
     * in the future.
     *
