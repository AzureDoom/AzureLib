...
/**
 * AzDynamicItemModelRenderer is an abstract extension of AzItemModelRenderer designed to handle
 * dynamic transformations, layer configurations, and rendering logic for item models in
 * intricate circumstances. It focuses on advanced rendering operations, including recursive
 * rendering of bone hierarchies and vertex-level manipulation.
 */
public abstract class AzDynamicItemModelRenderer extends AzItemModelRenderer {

    public AzDynamicItemModelRenderer(AzItemRendererPipeline itemRendererPipeline, AzLayerRenderer<ItemStack> layerRenderer) {
