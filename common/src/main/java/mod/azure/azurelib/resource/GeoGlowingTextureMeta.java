...
/**
 * Represents metadata for a glowing texture, used to define specific sections of an image that should glow. The data
 * can be sourced from JSON metadata or an existing image resource.
 */
