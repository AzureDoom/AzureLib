...
public final class FileLoader {
    ...
    /**
     * Loads and deserializes a model JSON file from the specified resource location. This method retrieves the file via
     * the provided resource manager and converts its contents into a {@link Model} object. If an error occurs during
     * file loading or parsing, the error is logged, and {@code null} is returned.
     *
     * @param location The resource location of the model file to be loaded.
     * @param manager  The resource manager responsible for accessing the resource.
     * @return The deserialized {@link Model} object, or {@code null} if an error occurs.
     */
