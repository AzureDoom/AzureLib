...
public class TargetOrRetaliate<E extends Mob> extends ExtendedBehaviour<E> {
    ...
    private static final List<Pair<MemoryModuleType<?>, MemoryStatus>> MEMORY_REQUIREMENTS = ObjectArrayList.of(
        ...
        Pair.of(MemoryModuleType.NEAREST_ATTACKABLE, MemoryStatus.REGISTERED),
        Pair.of(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, MemoryStatus.REGISTERED)
    );
    ...
    /**
     * Set the memory type that is checked first to target an entity. Useful for switching to player-only targeting
     *
     * @return this
     */
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, E owner) {
        ...
        if (this.toTarget == null) {
            ...
            if (this.toTarget == null) {
                NearestVisibleLivingEntities nearbyEntities = BrainUtils.getMemory(
                    brain,
