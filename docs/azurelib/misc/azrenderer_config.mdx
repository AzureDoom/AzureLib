    ...
    public ExampleArmorRenderer() {
        super(
            AzArmorRendererConfig.builder(MODEL, TEXTURE)
                ...
                .setRenderType(exampleArmor -> RenderType.entityTranslucent(TEXTURE)) // Sets RenderType with context
    ...
    public ExampleItemRenderer() {
        super(
            AzItemRendererConfig.builder(MODEL, TEXTURE)
                ...
                .setRenderType(RenderType.entityTranslucent(TEXTURE)) // Sets RenderType
                .setRenderType(exampleItem -> RenderType.entityTranslucent(TEXTURE)) // Sets RenderType with context
