...
### Step 1: Set Up and Add a Dynamic Model Renderer

Detailed instructions can be found at [Dynamic Model Renderers](../../../misc/rendering/dynamicmodelrenderers)

The resulting implementation of the Dynamic Model Renderer for your EntityRenderer should resemble the following example:
...
### Step 2: Add the Block and Item Layer to Your Renderer
...
4. **Geo Model Textures Renders Texture Atlas Instead**:
   - Verify that your Entity Renderer has implemented the custom rendering pipeline for a Dynamic Model Renderer.
