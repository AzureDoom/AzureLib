    ...
    public ExampleItemRenderer() {
        super(
            AzItemRendererConfig.builder(MODEL, TEXTURE)
                ...
                .disableAnimationInContexts(ItemTransforms.TransformType.GUI, ItemTransforms.TransformType.FIXED, ItemTransforms.TransformType.GROUND) // Disable animations in multiple contexts
                .enableAnimationOnlyInContexts(ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND, ItemTransforms.TransformType.FIRST_PERSON_RIGHT_HAND) // Enable animations in multiple contexts
                .setShouldAnimateInContext(context -> context != ItemTransforms.TransformType.GUI && context != ItemTransforms.TransformType.FIXED) // Custom animation logic with predicate
