...
<Callout variant="info">
    ...
    You can find working examples You can find working examples [here](https://github.com/AzureDoom/Azurelib-Rewrite-Examples/tree/1.19.2/common/src/main/java/mod/azure/azexamples/blocks/blockentity)
</Callout>
