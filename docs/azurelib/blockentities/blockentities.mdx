...
<Callout variant="info">
    ...
    You can find working examples [here](https://github.com/AzureDoom/Azurelib-Rewrite-Examples/tree/26.3/common/src/main/java/mod/azure/azexamples/blocks/blockentity)
</Callout>
