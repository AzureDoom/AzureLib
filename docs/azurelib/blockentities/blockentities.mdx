...
<Callout variant="info">
    ...
    You can find working examples [here](https://github.com/AzureDoom/Azurelib-Rewrite-Examples/tree/1.18.2/common/src/main/java/mod/azure/azexamples/blocks/blockentity)
</Callout>
...
<Callout variant="info">
    ...
    See [Dynamic Model Renderers](../misc/rendering/dynamicmodelrenderers#azdynamicblockentitymodelrenderer) for advanced options such as setting a render type or texture per bone.
</Callout>
