...
<Callout variant="info">
    ...
    You can find working examples for [1.21.1 here](https://github.com/AzureDoom/Azurelib-Rewrite-Examples/tree/1.21.x/common/src/main/java/mod/azure/azexamples/blocks/blockentity)
</Callout>
...
<Callout variant="info">
    You can find more about [AzCommands here](../misc/azcommands_101)
</Callout>
...
<Callout variant="info">
    See [AzRendererConfigs 101](../misc/azrenderer_config#azblockentityrendererconfig) for all AzBlockEntityRendererConfig#builder options.

    See [Dynamic Model Renderers](../misc/dynamicmodelrenderers#azdynamicblockentitymodelrenderer) for advanced options such as setting a render type or texture per bone.
