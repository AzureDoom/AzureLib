...
<Callout variant="info">
    This page assumes you have looked at the [AzAnimator Basics](../base_animator)  page
...
Below is a working example of a custom animator for an animimated item using the `AzItemAnimator`.
