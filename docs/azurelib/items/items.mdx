...
<Callout variant="info">
    See [AzRendererConfigs 101](../misc/azrenderer_config#azitemrendererconfig) for all AzItemRendererConfig#builder options.

    See [Dynamic Model Renderers](../misc/dynamicmodelrenderers#azdynamicitemmodelrenderer) for advanced options such as setting a render type or texture per bone.
...
## Registering your Item for proper animation triggering
