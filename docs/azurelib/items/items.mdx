...
```java
    @Override
    protected AzItemRendererPipeline<ItemStack> createPipeline(AzItemRendererConfig<ItemStack> config) {
        return new AzItemRendererPipeline<ItemStack>(config, this){
            @Override
