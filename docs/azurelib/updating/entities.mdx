...
<Callout variant="info">
    See here for a more [indepth example](../misc/azcommands_101#converting-from-animationcontroller-to-azcommand)
</Callout>
...
<Callout variant="info">
    See [here](../misc/azrenderer_config#azentityrendererconfig) for a more indepth example
</Callout>
