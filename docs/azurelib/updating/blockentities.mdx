...
<Callout variant="info">
    See [here](../misc/azcommands_101) for a more indepth info about AzCommands
</Callout>
...
<Callout variant="info">
    See [here](../misc/azrenderer_config#azblockentityrendererconfig) for a more indepth example
</Callout>
