...
<Callout variant="info">
    See [AzRendererConfigs 101](../misc/azrenderer_config#azarmorrendererconfig) for all AzArmorRendererConfig#builder options.

    See [Dynamic Model Renderers](../misc/dynamicmodelrenderers#azdynamicarmormodelrenderer) for advanced options such as setting a render type or texture per bone.
