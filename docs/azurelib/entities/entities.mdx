...
<Callout variant="info">
    ...
    See [Dynamic Model Renderers](../misc/rendering/dynamicmodelrenderers#azdynamicentitymodelrenderer) for advanced options such as setting a render type or texture per bone.
</Callout>
