...
<Callout variant="info">
    See [AzRendererConfigs 101](../misc/azrenderer_config#azentityrendererconfig) for all AzEntityRendererConfig#builder options.

    See [Dynamic Model Renderers](../misc/dynamicmodelrenderers#azdynamicentitymodelrenderer) for advanced options such as setting a render type or texture per bone.
