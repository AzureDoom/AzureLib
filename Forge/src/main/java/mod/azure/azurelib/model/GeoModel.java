    ...
    public void handleAnimations(T animatable, long instanceId, AnimationState<T> animationState) {
        ...
        if (currentTick == null)
            currentTick = animatable instanceof LivingEntity
                ? (double) ((LivingEntity) animatable).ticksExisted
    ...
    public void applyMolangQueries(T animatable, double animTime) {
        ...
        if (animatable instanceof Entity) {
            ...
            parser.setMemoizedValue(
                ...
                () -> RenderUtils.booleanToFloat(((Entity) animatable).onGround)
            );
            parser.setMemoizedValue(
            ...
            parser.setMemoizedValue(
                ...
                () -> RenderUtils.booleanToFloat(((Entity) animatable).isInWaterRainOrBubbleColumn())
            );
            parser.setMemoizedValue(
                MolangQueries.IS_ON_FIRE,
                () -> RenderUtils.booleanToFloat(((Entity) animatable).isBurning())
            );
            ...
            if (animatable instanceof LivingEntity) {
                ...
                parser.setMemoizedValue(
                    ...
                    () -> ((LivingEntity) animatable).rotationYaw - ((LivingEntity) animatable).prevRotationYaw
                );
            }
        }
    }
