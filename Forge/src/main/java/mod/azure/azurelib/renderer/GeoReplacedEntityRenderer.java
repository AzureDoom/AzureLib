...
public class GeoReplacedEntityRenderer<E extends Entity, T extends GeoAnimatable> extends EntityRenderer<E> implements GeoRenderer<T> {
    ...
    public void actuallyRender(
        ...
        boolean shouldSit = this.currentEntity.isPassenger() && (this.currentEntity.getVehicle() != null
            && this.currentEntity.getVehicle().shouldRiderSit());
        ...
        if (shouldSit && this.currentEntity.getVehicle() instanceof LivingEntity) {
            lerpBodyRot = MathHelper.rotLerp(
                partialTick,
                ((LivingEntity) currentEntity.getVehicle()).yBodyRotO,
    ...
    public boolean shouldShowName(E entity) {
        ...
        if (
            entity instanceof MobEntity && (!entity.shouldShowName() && (!entity.hasCustomName()
    ...
    public <H extends Entity, M extends MobEntity> void renderLeash(
        ...
        double lerpBodyAngle = (MathHelper.lerp(
            partialTick,
            mob.yBodyRotO,
            mob.yBodyRot
