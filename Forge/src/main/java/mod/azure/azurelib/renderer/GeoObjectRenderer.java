...
public class GeoObjectRenderer<T extends GeoAnimatable> implements GeoRenderer<T> {
    ...
    public boolean firePreRenderEvent(
        ...
        return !MinecraftForge.EVENT_BUS.post(
            new GeoRenderEvent.Object.Pre(this, poseStack, model, bufferSource, partialTick, packedLight)
        );
    }
    ...
    public void firePostRenderEvent(
        ...
        MinecraftForge.EVENT_BUS.post(
            new GeoRenderEvent.Object.Post(this, poseStack, model, bufferSource, partialTick, packedLight)
        );
    }
}
