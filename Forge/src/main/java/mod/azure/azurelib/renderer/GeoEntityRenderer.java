...
public class GeoEntityRenderer<T extends Entity & GeoAnimatable> extends EntityRenderer<T> implements GeoRenderer<T> {
    ...
    public void actuallyRender(
        ...
        boolean shouldSit = animatable.isPassenger() && (animatable.getVehicle() != null && animatable.getVehicle()
            .shouldRiderSit());
    ...
    public boolean firePreRenderEvent(
        ...
        return !MinecraftForge.EVENT_BUS.post(
            new GeoRenderEvent.Entity.Pre(this, poseStack, model, bufferSource, partialTick, packedLight)
        );
    }
    ...
    public void firePostRenderEvent(
        ...
        MinecraftForge.EVENT_BUS.post(
            new GeoRenderEvent.Entity.Post(this, poseStack, model, bufferSource, partialTick, packedLight)
        );
    }
}
