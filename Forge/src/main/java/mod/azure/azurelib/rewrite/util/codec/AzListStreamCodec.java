...
public class AzListStreamCodec<T> {
    ...
    private final Function<PacketBuffer, T> decoder; // Function to decode an element from the buffer

    private final BiConsumer<PacketBuffer, T> encoder; // BiConsumer to encode an element into the buffer
