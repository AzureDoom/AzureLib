...
public class AzActionRegistry {
     ...
     */
    public static Function<FriendlyByteBuf, ? extends AzAction> getDecoderOrNull(
     ...
     */
    public static Function<FriendlyByteBuf, AzAction> getDecoderOrNull(short id) {
        return DECODERS_BY_ID.get(id);
    }
     ...
     */
    public static BiConsumer<FriendlyByteBuf, AzAction> getEncoderOrNull(ResourceLocation resourceLocation) {
        var id = RESOURCE_LOCATION_TO_ID.get(resourceLocation);
     ...
     */
    public static BiConsumer<FriendlyByteBuf, AzAction> getEncoderOrNull(short id) {
        return ENCODERS_BY_ID.get(id);
    }
