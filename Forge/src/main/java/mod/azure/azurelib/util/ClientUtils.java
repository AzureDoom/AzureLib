...
public final class ClientUtils {
     ...
     *
     * @return the {@link PlayerEntity} instance corresponding to the local client player, or null if the player is not
     *         available
     */
    ...
    /**
     * Retrieves the current client-side {@link World} instance.
     *
    ...
    public static AzAnimationController<Object> getCurrentAnimationController(Object target, String controllerName) {
        ...
        AzAnimationController<Object> animationController = animator.getAnimationControllerContainer()
            .getOrNull(controllerName);
    ...
    public static double getCurrentAnimationTick(Object target, String controllerName) {
        if (target instanceof Entity && !((Entity) target).level.isClientSide) {
