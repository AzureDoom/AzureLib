...
public final class AzureLibUtil {
	 ...
	 */
	public static void summonAoE(LivingEntity entity, ParticleOptions particle, int yOffset, int duration, float radius, boolean hasEffect, MobEffect effect, int effectTime) {
