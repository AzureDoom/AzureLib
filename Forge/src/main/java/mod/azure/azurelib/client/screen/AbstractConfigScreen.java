...
public abstract class AbstractConfigScreen extends Screen {
    ...
    private void buttonRevertToDefaultClicked(Button button) {
        DialogScreen dialog = new DialogScreen(
            ...
            new ITextComponent[] { ConfigEntryWidget.REVERT_DEFAULTS_DIALOG_TEXT },
            this
        );
    ...
    private void buttonRevertChangesClicked(Button button) {
        DialogScreen dialog = new DialogScreen(
            ...
            new ITextComponent[] { ConfigEntryWidget.REVERT_CHANGES_DIALOG_TEXT },
            this
        );
        dialog.onConfirmed(screen -> {
    ...
    public void renderNotification(
        ...
        if (!texts.isEmpty()) {
            ...
            IRenderTypeBuffer.Impl irendertypebuffer$impl = IRenderTypeBuffer.immediate(
