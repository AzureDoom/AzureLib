...
public interface GeoItem extends SingletonGeoAnimatable {
	...
	/**
	 * Whether this item animatable is perspective aware, handling animations differently depending on the {@link net.minecraft.world.item.TransformType render perspective}
	 */
