 ...
 * Additionally, it encourages use of cached {@link mod.azure.azurelib.core.animation.RawAnimation RawAnimations}, to
 * reduce overheads.
 */
@Deprecated()
public final class DefaultAnimations {
     ...
     * Plays the spawn animation as long as the current {@link GeoAnimatable#getTick tick} of the animatable is <= the
     * value provided in {@code ticks}.<br>
     ...
     * <li>{@link mod.azure.azurelib.animatable.GeoReplacedEntity GeoReplacedEntity}: state ->
     * state.getData(DataTickets.ENTITY)</li>
