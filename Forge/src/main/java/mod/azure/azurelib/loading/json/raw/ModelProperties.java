...
public class ModelProperties {
	...
	public static JsonDeserializer<ModelProperties> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			final String identifier = JSONUtils.getAsString(obj, "identifier", null);
			final Boolean preserveModelPose = JsonUtil.getOptionalBoolean(obj, "preserve_model_pose");
			final double textureHeight = JSONUtils.getAsFloat(obj, "texture_height");
			final double textureWidth = JSONUtils.getAsFloat(obj, "texture_width");
			final Double visibleBoundsHeight = JsonUtil.getOptionalDouble(obj, "visible_bounds_height");
			final double[] visibleBoundsOffset = JsonUtil.jsonArrayToDoubleArray(JSONUtils.getAsJsonArray(obj, "visible_bounds_offset", null));
