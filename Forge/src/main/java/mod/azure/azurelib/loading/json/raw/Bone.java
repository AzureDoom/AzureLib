    ...
    public static JsonDeserializer<Bone> deserializer() throws JsonParseException {
        return (json, type, context) -> {
            ...
            Cube[] cubes = JsonUtil.jsonArrayToObjectArray(
                JSONUtils.getJsonArray(obj, "cubes", new JsonArray()),
                context,
                Cube.class
            );
            ...
            Map<String, LocatorValue> locators = obj.has("locators")
                ? JsonUtil.jsonObjToMap(JSONUtils.getJsonObject(obj, "locators"), context, LocatorValue.class)
                : null;
            ...
            TextureMesh[] textureMeshes = JsonUtil.jsonArrayToObjectArray(
                JSONUtils.getJsonArray(obj, "texture_meshes", new JsonArray()),
                context,
                TextureMesh.class
            );
